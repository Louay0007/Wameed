    ...
    <div className="bg-dark py-8 px-4 md:px-6">
      ...
      <div className="flex flex-col items-center justify-center mb-10 animate-fade-in-up">
        <div className="relative flex flex-col items-center justify-center">
          ...
          <p className="text-green-400 text-base md:text-lg font-semibold mt-1 text-center">In solidarity with Palestine — From the river to the sea palestine will be free .</p>
